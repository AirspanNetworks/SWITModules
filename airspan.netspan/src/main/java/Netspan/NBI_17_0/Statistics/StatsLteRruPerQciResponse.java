 ...
 *       &lt;sequence&gt;
 *         &lt;element name="StatisticsResult" type="{http://Airspan.Netspan.WebServices}NodeLteRruPerQciStatsResult" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    extends WsResponse
{
    ...
    protected List<NodeLteRruPerQciStatsResult> statisticsResult;
     ...
     * 
     */
    public List<NodeLteRruPerQciStatsResult> getStatisticsResult() {
        if (statisticsResult == null) {
            statisticsResult = new ArrayList<NodeLteRruPerQciStatsResult>();
        }
