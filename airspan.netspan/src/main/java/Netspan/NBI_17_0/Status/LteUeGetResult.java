...
/**
 * <p>Java class for LteUeGetResult complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LteUeGetResult"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Cell" type="{http://Airspan.Netspan.WebServices}LteUeStatusWs" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "LteUeGetResult", propOrder = {
    "nodeResult",
    "name",
    "nodeId",
    "cell"
})
public class LteUeGetResult
    extends WsResponse
{
    ...
    protected List<LteUeStatusWs> cell;
     ...
     * 
     */
    public List<LteUeStatusWs> getCell() {
        if (cell == null) {
            cell = new ArrayList<LteUeStatusWs>();
        }
        return this.cell;
    }
