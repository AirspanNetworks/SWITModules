 ...
 *         &lt;element name="RejectNonEmergencyMoDt" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
public class LteMmeStatsRowWs {
    ...
    @XmlElement(name = "RejectNonEmergencyMoDt", required = true, type = Integer.class, nillable = true)
    protected Integer rejectNonEmergencyMoDt;
     ...
     *     
     */
    public Integer getRejectNonEmergencyMoDt() {
     ...
     *     
     */
    public void setRejectNonEmergencyMoDt(Integer value) {
