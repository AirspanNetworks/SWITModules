 ...
 *         &lt;element name="LongSbaEnable" type="{http://Airspan.Netspan.WebServices}EnabledDisabledStates"/>
 *         &lt;element name="LongAntennaBeam" type="{http://Airspan.Netspan.WebServices}SupportedAntennaBeams"/>
...
public class LteEnbDetailsSetWsPnp {
    ...
    @XmlElement(name = "LongSbaEnable", required = true, nillable = true)
    @XmlSchemaType(name = "string")
    protected EnabledDisabledStates longSbaEnable;
    @XmlElement(name = "LongAntennaBeam", required = true, nillable = true)
    @XmlSchemaType(name = "string")
    protected SupportedAntennaBeams longAntennaBeam;
     ...
     *     
     */
    public EnabledDisabledStates getLongSbaEnable() {
     ...
     *     
     */
    public void setLongSbaEnable(EnabledDisabledStates value) {
     ...
     * @return
     *     possible object is
     *     {@link SupportedAntennaBeams }
     *     
     */
    public SupportedAntennaBeams getLongAntennaBeam() {
     ...
     *     
     */
    public void setLongAntennaBeam(SupportedAntennaBeams value) {
