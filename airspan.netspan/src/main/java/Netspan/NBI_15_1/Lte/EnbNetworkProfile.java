 ...
 *         &lt;element name="IsMgmtVlanConfigured" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="MgmtVlanId" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
...
public class EnbNetworkProfile {
    ...
    @XmlElementRef(name = "IsMgmtVlanConfigured", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> isMgmtVlanConfigured;
    @XmlElementRef(name = "MgmtVlanId", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> mgmtVlanId;
    ...
    /**
     * Gets the value of the isMgmtVlanConfigured property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Boolean }{@code >}
     *     
     */
    public JAXBElement<Boolean> getIsMgmtVlanConfigured() {
        return isMgmtVlanConfigured;
    }

    /**
     * Sets the value of the isMgmtVlanConfigured property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Boolean }{@code >}
     *     
     */
    public void setIsMgmtVlanConfigured(JAXBElement<Boolean> value) {
        this.isMgmtVlanConfigured = value;
    }

    /**
     * Gets the value of the mgmtVlanId property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Integer }{@code >}
     *     
     */
    public JAXBElement<Integer> getMgmtVlanId() {
        return mgmtVlanId;
    }

    /**
     * Sets the value of the mgmtVlanId property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Integer }{@code >}
     *     
     */
    public void setMgmtVlanId(JAXBElement<Integer> value) {
        this.mgmtVlanId = value;
    }
