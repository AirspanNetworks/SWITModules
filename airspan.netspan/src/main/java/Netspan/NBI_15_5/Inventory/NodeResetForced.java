 ...
 *         &lt;element name="IsResetRequired" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "NodeResetForced")
public class NodeResetForced {

    @XmlElement(name = "NodeName")
    protected List<String> nodeName;
    @XmlElement(name = "NodeId")
    protected List<String> nodeId;
    @XmlElement(name = "IsResetRequired", required = true, type = Boolean.class, nillable = true)
     ...
     *     
     */
    public Boolean isIsResetRequired() {
     ...
     *     
     */
    public void setIsResetRequired(Boolean value) {
