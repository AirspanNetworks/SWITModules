 ...
 *         &lt;element name="NonContiguousCERIsDefault" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *         &lt;element name="NonContiguousCER" type="{http://Airspan.Netspan.WebServices}EnabledDisabledStates"/>
...
public class CellDynamicIcicWs {
    ...
    @XmlElement(name = "NonContiguousCERIsDefault", required = true, type = Boolean.class, nillable = true)
     ...
     *     
     */
    public Boolean isNonContiguousCERIsDefault() {
     ...
     *     
     */
    public void setNonContiguousCERIsDefault(Boolean value) {
