...
@javax.jws.WebService(
                      ...
                      wsdlLocation = "http://192.168.58.46/ws/16.0/Inventory.asmx?WSDL",
...
public class InventorySoapImpl implements InventorySoap {
    ...
    /* (non-Javadoc)
     * @see Netspan.NBI_16_0.Inventory.InventorySoap#nodeResetForcedColdFactory(java.util.List<java.lang.String> nodeName, java.util.List<java.lang.String> nodeId, Netspan.NBI_16_0.Inventory.Credentials credentials)*
     */
    public Netspan.NBI_16_0.Inventory.NodeActionResult nodeResetForcedColdFactory(java.util.List<java.lang.String> nodeName, java.util.List<java.lang.String> nodeId, Credentials credentials) {
    ...
    /* (non-Javadoc)
     * @see Netspan.NBI_16_0.Inventory.InventorySoap#nodeResetCold(java.util.List<java.lang.String> nodeName, java.util.List<java.lang.String> nodeId, Netspan.NBI_16_0.Inventory.Credentials credentials)*
     */
    public Netspan.NBI_16_0.Inventory.NodeActionResult nodeResetCold(java.util.List<java.lang.String> nodeName, java.util.List<java.lang.String> nodeId, Credentials credentials) {
    ...
    /* (non-Javadoc)
     * @see Netspan.NBI_16_0.Inventory.InventorySoap#nodeHardwareSwap(java.lang.String oldNode, java.lang.String newNode, Netspan.NBI_16_0.Inventory.Credentials credentials)*
     */
    public Netspan.NBI_16_0.Inventory.NodeActionResult nodeHardwareSwap(java.lang.String oldNode, java.lang.String newNode, Credentials credentials) {
