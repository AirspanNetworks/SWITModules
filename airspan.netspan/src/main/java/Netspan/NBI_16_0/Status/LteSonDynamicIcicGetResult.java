...
/**
 * <p>Java class for LteSonDynamicIcicGetResult complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LteSonDynamicIcicGetResult">
 *   &lt;complexContent>
 ...
 *         &lt;element name="Cell" type="{http://Airspan.Netspan.WebServices}LteDicicStatusWs" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "LteSonDynamicIcicGetResult", propOrder = {
    "nodeResult",
    "name",
    "nodeId",
    "cell"
})
public class LteSonDynamicIcicGetResult
    extends WsResponse
{
    ...
    protected List<LteDicicStatusWs> cell;
     ...
     * {@link LteDicicStatusWs }
     * 
     * 
     */
    public List<LteDicicStatusWs> getCell() {
        if (cell == null) {
            cell = new ArrayList<LteDicicStatusWs>();
        }
        return this.cell;
    }
