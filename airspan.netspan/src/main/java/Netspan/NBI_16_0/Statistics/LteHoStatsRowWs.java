 ...
 *         &lt;element name="HoS1OutSuccToHeNBUnspecified" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
public class LteHoStatsRowWs {
    ...
    @XmlElement(name = "HoS1OutSuccToHeNBUnspecified", required = true, type = Integer.class, nillable = true)
    protected Integer hoS1OutSuccToHeNBUnspecified;
     ...
     *     
     */
    public Integer getHoS1OutSuccToHeNBUnspecified() {
     ...
     *     
     */
    public void setHoS1OutSuccToHeNBUnspecified(Integer value) {
