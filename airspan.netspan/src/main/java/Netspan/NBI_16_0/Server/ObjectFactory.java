 ...
 * generated in the Netspan.NBI_16_0.Server package. 
...
public class ObjectFactory {
    ...
    private final static QName _NmsLicenseSummaryWsExpiryDate_QNAME = new QName("http://Airspan.Netspan.WebServices", "ExpiryDate");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: Netspan.NBI_16_0.Server
     * 
     */
    ...
    public JAXBElement<XMLGregorianCalendar> createNmsLicenseSummaryWsExpiryDate(XMLGregorianCalendar value) {
        return new JAXBElement<XMLGregorianCalendar>(_NmsLicenseSummaryWsExpiryDate_QNAME, XMLGregorianCalendar.class, NmsLicenseSummaryWs.class, value);
    }
    ...
    public JAXBElement<XMLGregorianCalendar> createNmsLicensedNodesWsExpiryDate(XMLGregorianCalendar value) {
        return new JAXBElement<XMLGregorianCalendar>(_NmsLicenseSummaryWsExpiryDate_QNAME, XMLGregorianCalendar.class, NmsLicensedNodesWs.class, value);
    }
    ...
    public JAXBElement<XMLGregorianCalendar> createNmsLicenseWsExpiryDate(XMLGregorianCalendar value) {
        return new JAXBElement<XMLGregorianCalendar>(_NmsLicenseSummaryWsExpiryDate_QNAME, XMLGregorianCalendar.class, NmsLicenseWs.class, value);
    }
