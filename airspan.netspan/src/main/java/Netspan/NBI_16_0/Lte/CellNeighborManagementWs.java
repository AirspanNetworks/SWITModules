 ...
 *         &lt;element name="MeasRemoveThresholdRatioIsDefault" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="MeasRemoveThresholdRatio" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
 ...
 *         &lt;element name="AddCsgInfoToCgiQueryIsDefault" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="AddCsgInfoToCgiQuery" type="{http://Airspan.Netspan.WebServices}EnabledDisabledStates" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CellNeighborManagementWs", propOrder = {
    ...
    "initialPiMetric",
    "measRemoveThresholdRatioIsDefault",
    "measRemoveThresholdRatio",
    "hoAttemptsThresholdIsDefault",
    "hoAttemptsThreshold",
    "numberOfPciToQueryForCgiIsDefault",
    "numberOfPciToQueryForCgi",
    "addCsgInfoToCgiQueryIsDefault",
    "addCsgInfoToCgiQuery"
})
public class CellNeighborManagementWs {
    ...
    @XmlElementRef(name = "MeasRemoveThresholdRatioIsDefault", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> measRemoveThresholdRatioIsDefault;
    @XmlElementRef(name = "MeasRemoveThresholdRatio", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> measRemoveThresholdRatio;
    ...
    /**
     * Gets the value of the measRemoveThresholdRatioIsDefault property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Boolean }{@code >}
     *     
     */
    public JAXBElement<Boolean> getMeasRemoveThresholdRatioIsDefault() {
        return measRemoveThresholdRatioIsDefault;
    }

    /**
     * Sets the value of the measRemoveThresholdRatioIsDefault property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Boolean }{@code >}
     *     
     */
    public void setMeasRemoveThresholdRatioIsDefault(JAXBElement<Boolean> value) {
        this.measRemoveThresholdRatioIsDefault = value;
    }

    /**
     * Gets the value of the measRemoveThresholdRatio property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Integer }{@code >}
     *     
     */
    public JAXBElement<Integer> getMeasRemoveThresholdRatio() {
        return measRemoveThresholdRatio;
    }

    /**
     * Sets the value of the measRemoveThresholdRatio property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Integer }{@code >}
     *     
     */
    public void setMeasRemoveThresholdRatio(JAXBElement<Integer> value) {
        this.measRemoveThresholdRatio = value;
    }
    ...
    /**
     * Gets the value of the addCsgInfoToCgiQueryIsDefault property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Boolean }{@code >}
     *     
     */
    public JAXBElement<Boolean> getAddCsgInfoToCgiQueryIsDefault() {
        return addCsgInfoToCgiQueryIsDefault;
    }

    /**
     * Sets the value of the addCsgInfoToCgiQueryIsDefault property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Boolean }{@code >}
     *     
     */
    public void setAddCsgInfoToCgiQueryIsDefault(JAXBElement<Boolean> value) {
        this.addCsgInfoToCgiQueryIsDefault = value;
    }

    /**
     * Gets the value of the addCsgInfoToCgiQuery property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the addCsgInfoToCgiQuery property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link EnabledDisabledStates }{@code >}
