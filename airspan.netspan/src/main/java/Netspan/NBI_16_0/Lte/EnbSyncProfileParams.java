 ...
 *         &lt;element name="Priority2ClockSource" type="{http://Airspan.Netspan.WebServices}ClockSources" minOccurs="0"/>
...
public class EnbSyncProfileParams {
    ...
    @XmlElementRef(name = "Priority2ClockSource", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<ClockSources> priority2ClockSource;
    ...
    /**
     * Gets the value of the priority2ClockSource property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ClockSources }{@code >}
     *     
     */
    public JAXBElement<ClockSources> getPriority2ClockSource() {
        return priority2ClockSource;
    }

    /**
     * Sets the value of the priority2ClockSource property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ClockSources }{@code >}
     *     
     */
    public void setPriority2ClockSource(JAXBElement<ClockSources> value) {
        this.priority2ClockSource = value;
    }
