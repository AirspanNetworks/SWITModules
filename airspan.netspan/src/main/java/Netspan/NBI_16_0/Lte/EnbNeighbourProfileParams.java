 ...
 *       &lt;sequence>
 *         &lt;element name="NrtEnabled" type="{http://Airspan.Netspan.WebServices}EnabledDisabledStates" minOccurs="0"/>
...
public class EnbNeighbourProfileParams {
    ...
    /**
     * Gets the value of the nrtEnabled property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the nrtEnabled property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link EnabledDisabledStates }{@code >}
