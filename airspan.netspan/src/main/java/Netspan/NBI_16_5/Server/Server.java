...
public class Server extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.58.233/ws/16.5/Server.asmx?WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Server.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://192.168.58.233/ws/16.5/Server.asmx?WSDL");
        }
        WSDL_LOCATION = url;
    }
