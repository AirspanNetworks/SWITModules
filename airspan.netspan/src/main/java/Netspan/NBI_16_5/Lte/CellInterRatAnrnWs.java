 ...
 *         &lt;element name="RemovalThreshold" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/&gt;
 ...
 *         &lt;element name="DrxLongCycleIsDefault" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element name="DrxLongCycle" type="{http://Airspan.Netspan.WebServices}InterRatDrxCycle" minOccurs="0"/&gt;
 *         &lt;element name="RollbackTimerIsDefault" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
...
public class CellInterRatAnrnWs {
    ...
    @XmlElementRef(name = "RemovalThreshold", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> removalThreshold;
    ...
    @XmlElementRef(name = "DrxLongCycleIsDefault", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> drxLongCycleIsDefault;
    ...
    @XmlElementRef(name = "RollbackTimerIsDefault", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> rollbackTimerIsDefault;
     ...
     *     
     */
    public JAXBElement<Integer> getRemovalThreshold() {
     ...
     *     
     */
    public void setRemovalThreshold(JAXBElement<Integer> value) {
     ...
     *     
     */
    public JAXBElement<Boolean> getDrxLongCycleIsDefault() {
     ...
     *     
     */
    public void setDrxLongCycleIsDefault(JAXBElement<Boolean> value) {
     ...
     *     
     */
    public JAXBElement<Boolean> getRollbackTimerIsDefault() {
     ...
     *     
     */
    public void setRollbackTimerIsDefault(JAXBElement<Boolean> value) {
