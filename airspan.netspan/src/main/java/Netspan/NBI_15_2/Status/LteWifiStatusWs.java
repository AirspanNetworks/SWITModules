...
/**
 * <p>Java class for LteWifiStatusWs complex type.
 * 
...
@XmlType(name = "LteWifiStatusWs", propOrder = {
    "rfNumber",
    "statusInformation",
    "operationalStatus",
    "ipAddress",
...
public class LteWifiStatusWs {
    ...
    protected JAXBElement<Integer> operationalStatus;
     ...
     *     
     */
    public JAXBElement<Integer> getOperationalStatus() {
     ...
     *     
     */
    public void setOperationalStatus(JAXBElement<Integer> value) {
     ...
     *     
     */
    public JAXBElement<Integer> getWorstSeverityAlarm() {
