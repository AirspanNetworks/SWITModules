 ...
 *         &lt;element name="RadioProfile" type="{http://Airspan.Netspan.WebServices}EnbMultiCellProfile" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class MultiCellProfileClone {
    ...
    protected EnbMultiCellProfile radioProfile;
     ...
     *     
     */
    public EnbMultiCellProfile getRadioProfile() {
        return radioProfile;
    }
     ...
     *     
     */
    public void setRadioProfile(EnbMultiCellProfile value) {
