...
/**
 * <p>Java class for LteSonMcimGetResult complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LteSonMcimGetResult"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Cell" type="{http://Airspan.Netspan.WebServices}LteSonMcimsWs" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "LteSonMcimGetResult", propOrder = {
    "nodeResult",
    "name",
    "nodeId",
    "cell"
})
public class LteSonMcimGetResult
    extends WsResponse
{
    ...
    protected List<LteSonMcimsWs> cell;
     ...
     * 
     */
    public List<LteSonMcimsWs> getCell() {
        if (cell == null) {
            cell = new ArrayList<LteSonMcimsWs>();
        }
        return this.cell;
    }
