 ...
 *         &lt;element name="HardwareType" type="{http://Airspan.Netspan.WebServices}IbTermPnpHardwareTypes" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class IBridgeTermPnpConfigGet {
    ...
    protected List<IbTermPnpHardwareTypes> hardwareType;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link IbTermPnpHardwareTypes }
     * 
     * 
     */
    public List<IbTermPnpHardwareTypes> getHardwareType() {
        if (hardwareType == null) {
            hardwareType = new ArrayList<IbTermPnpHardwareTypes>();
        }
