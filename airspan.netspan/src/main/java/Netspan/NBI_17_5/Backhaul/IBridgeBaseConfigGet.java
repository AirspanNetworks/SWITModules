 ...
 *         &lt;element name="HardwareType" type="{http://Airspan.Netspan.WebServices}IBridgeBaseModelIds" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "IBridgeBaseConfigGet")
public class IBridgeBaseConfigGet {

    @XmlElement(name = "NodeName")
    protected List<String> nodeName;
    @XmlElement(name = "HardwareType")
    @XmlSchemaType(name = "string")
    protected List<IBridgeBaseModelIds> hardwareType;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link IBridgeBaseModelIds }
     * 
     * 
     */
    public List<IBridgeBaseModelIds> getHardwareType() {
        if (hardwareType == null) {
            hardwareType = new ArrayList<IBridgeBaseModelIds>();
        }
