 ...
 *         &lt;element name="HardwareType" type="{http://Airspan.Netspan.WebServices}IBridge2PnpHardwareTypes" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "IBridge2PnpConfigGet")
public class IBridge2PnpConfigGet {

    @XmlElement(name = "NodeName")
    protected List<String> nodeName;
    @XmlElement(name = "HardwareType")
    @XmlSchemaType(name = "string")
    protected List<IBridge2PnpHardwareTypes> hardwareType;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link IBridge2PnpHardwareTypes }
     * 
     * 
     */
    public List<IBridge2PnpHardwareTypes> getHardwareType() {
        if (hardwareType == null) {
            hardwareType = new ArrayList<IBridge2PnpHardwareTypes>();
        }
