...
/**
 * <p>Java class for RelayEnbModelIds.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="RelayEnbModelIds"&gt;
 ...
 * 
 */
@XmlType(name = "RelayEnbModelIds")
@XmlEnum
public enum RelayEnbModelIds {
    ...
    public static RelayEnbModelIds fromValue(String v) {
        for (RelayEnbModelIds c: RelayEnbModelIds.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
