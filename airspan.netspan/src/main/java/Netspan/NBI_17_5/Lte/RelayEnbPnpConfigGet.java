 ...
 *         &lt;element name="HardwareType" type="{http://Airspan.Netspan.WebServices}RelayEnbPnpHardwareTypes" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "RelayEnbPnpConfigGet")
public class RelayEnbPnpConfigGet {

    @XmlElement(name = "NodeName")
    protected List<String> nodeName;
    @XmlElement(name = "HardwareType")
    @XmlSchemaType(name = "string")
    protected List<RelayEnbPnpHardwareTypes> hardwareType;
     ...
     * 
     */
    public List<RelayEnbPnpHardwareTypes> getHardwareType() {
        if (hardwareType == null) {
            hardwareType = new ArrayList<RelayEnbPnpHardwareTypes>();
        }
