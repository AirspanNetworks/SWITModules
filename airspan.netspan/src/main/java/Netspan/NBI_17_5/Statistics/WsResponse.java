...
@XmlSeeAlso({
    ...
    StatsIBridge2RfResponse.class,
    StatsIBridge2ThroughputResponse.class,
    StatsIBridge2EthernetResponse.class,
    StatsIBridge2QosResponse.class,
    ...
    StatsLteRruPerItbsResponse.class,
    ...
    StatsLteRruVoltePerMcsResponse.class,
    StatsLteVolteWbCqiResponse.class,
    StatsLteDynamicAcbResponse.class,
    StatsLteUePrachInitialTimingAdvanceResponse.class,
