 ...
 *       &lt;sequence&gt;
 *         &lt;element name="StatisticsResult" type="{http://Airspan.Netspan.WebServices}NodeLtePerCellHoStatsResult" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    extends WsResponse
{
    ...
    protected List<NodeLtePerCellHoStatsResult> statisticsResult;
     ...
     * 
     */
    public List<NodeLtePerCellHoStatsResult> getStatisticsResult() {
        if (statisticsResult == null) {
            statisticsResult = new ArrayList<NodeLtePerCellHoStatsResult>();
        }
