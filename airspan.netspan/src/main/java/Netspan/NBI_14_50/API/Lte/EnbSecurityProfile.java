 ...
 *         &lt;element name="IpSecEnabled" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
...
public class EnbSecurityProfile {
    ...
    @XmlElementRef(name = "IpSecEnabled", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> ipSecEnabled;
     ...
     *     
     */
    public JAXBElement<Boolean> getIpSecEnabled() {
        return ipSecEnabled;
    }
     ...
     *     
     */
    public void setIpSecEnabled(JAXBElement<Boolean> value) {
