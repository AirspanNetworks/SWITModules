 ...
 *       &lt;sequence>
 *         &lt;element name="Task" type="{http://Airspan.Netspan.WebServices}NodeResult" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends WsResponse
{
    ...
    protected List<NodeResult> task;
     ...
     * 
     */
    public List<NodeResult> getTask() {
        if (task == null) {
            task = new ArrayList<NodeResult>();
        }
        return this.task;
    }
