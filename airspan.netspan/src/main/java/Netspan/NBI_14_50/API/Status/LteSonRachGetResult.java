...
/**
 * <p>Java class for LteSonRachGetResult complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LteSonRachGetResult">
 *   &lt;complexContent>
 ...
 *         &lt;element name="Cell" type="{http://Airspan.Netspan.WebServices}LteRachStatusWs" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "LteSonRachGetResult", propOrder = {
    "nodeResult",
    "name",
    "nodeId",
    "cell"
})
public class LteSonRachGetResult
    extends WsResponse
{
    ...
    protected List<LteRachStatusWs> cell;
     ...
     * {@link LteRachStatusWs }
     * 
     * 
     */
    public List<LteRachStatusWs> getCell() {
        if (cell == null) {
            cell = new ArrayList<LteRachStatusWs>();
        }
        return this.cell;
    }
