 ...
 *         &lt;element name="PciStatus" type="{http://Airspan.Netspan.WebServices}ManualAutomaticValues"/>
    ...
    extends WsResponse
{
    ...
    @XmlElement(name = "PciStatus", required = true)
    @XmlSchemaType(name = "string")
    protected ManualAutomaticValues pciStatus;
     ...
     *     
     */
    public ManualAutomaticValues getPciStatus() {
        return pciStatus;
    }
     ...
     *     
     */
    public void setPciStatus(ManualAutomaticValues value) {
