...
/**
 * <p>Java class for RelayModelIds.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="RelayModelIds"&gt;
 ...
 * 
 */
@XmlType(name = "RelayModelIds")
@XmlEnum
public enum RelayModelIds {
    ...
    public static RelayModelIds fromValue(String v) {
        for (RelayModelIds c: RelayModelIds.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
