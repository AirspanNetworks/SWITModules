 ...
 *         &lt;element name="HardwareType" type="{http://Airspan.Netspan.WebServices}IBridge2ModelIds" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "IBridge2ConfigGet")
public class IBridge2ConfigGet {

    @XmlElement(name = "NodeName")
    protected List<String> nodeName;
    @XmlElement(name = "HardwareType")
    @XmlSchemaType(name = "string")
    protected List<IBridge2ModelIds> hardwareType;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link IBridge2ModelIds }
     * 
     * 
     */
    public List<IBridge2ModelIds> getHardwareType() {
        if (hardwareType == null) {
            hardwareType = new ArrayList<IBridge2ModelIds>();
        }
