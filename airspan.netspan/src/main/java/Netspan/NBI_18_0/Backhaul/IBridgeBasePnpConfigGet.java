 ...
 *         &lt;element name="HardwareType" type="{http://Airspan.Netspan.WebServices}IbBasePnpHardwareTypes" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class IBridgeBasePnpConfigGet {
    ...
    protected List<IbBasePnpHardwareTypes> hardwareType;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link IbBasePnpHardwareTypes }
     * 
     * 
     */
    public List<IbBasePnpHardwareTypes> getHardwareType() {
        if (hardwareType == null) {
            hardwareType = new ArrayList<IbBasePnpHardwareTypes>();
        }
