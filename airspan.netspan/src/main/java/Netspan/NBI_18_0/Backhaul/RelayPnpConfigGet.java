 ...
 *         &lt;element name="HardwareType" type="{http://Airspan.Netspan.WebServices}RelayPnpHardwareTypes" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "RelayPnpConfigGet")
public class RelayPnpConfigGet {

    @XmlElement(name = "NodeName")
    protected List<String> nodeName;
    @XmlElement(name = "HardwareType")
    @XmlSchemaType(name = "string")
    protected List<RelayPnpHardwareTypes> hardwareType;
     ...
     * 
     */
    public List<RelayPnpHardwareTypes> getHardwareType() {
        if (hardwareType == null) {
            hardwareType = new ArrayList<RelayPnpHardwareTypes>();
        }
