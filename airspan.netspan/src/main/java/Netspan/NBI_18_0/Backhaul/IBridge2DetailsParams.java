 ...
 *         &lt;element name="TimeSource" type="{http://Airspan.Netspan.WebServices}TimeSources" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class IBridge2DetailsParams {
    ...
    @XmlElementRef(name = "TimeSource", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<TimeSources> timeSource;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link TimeSources }{@code >}
     *     
     */
    public JAXBElement<TimeSources> getTimeSource() {
        return timeSource;
    }
     ...
     *     
     */
    public void setTimeSource(JAXBElement<TimeSources> value) {
