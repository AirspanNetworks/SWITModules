...
@XmlSeeAlso({
    ...
    IBridge2ConfigGetResult.class,
    NodeListResult.class,
    IBridge2PnpConfigGetResult.class,
    ...
    IBridge2BaseManagementProfileGetResult.class,
    IBridge2TermManagementProfileGetResult.class,
    IBridge2AlarmProfileGetResult.class,
    IBridge2QosProfileGetResult.class,
    RelayGlobalConfigGetResult.class,
