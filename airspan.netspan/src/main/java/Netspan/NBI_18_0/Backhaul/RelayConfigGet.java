 ...
 *         &lt;element name="HardwareType" type="{http://Airspan.Netspan.WebServices}RelayModelIds" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "RelayConfigGet")
public class RelayConfigGet {

    @XmlElement(name = "NodeName")
    protected List<String> nodeName;
    @XmlElement(name = "HardwareType")
    @XmlSchemaType(name = "string")
    protected List<RelayModelIds> hardwareType;
     ...
     * 
     */
    public List<RelayModelIds> getHardwareType() {
        if (hardwareType == null) {
            hardwareType = new ArrayList<RelayModelIds>();
        }
