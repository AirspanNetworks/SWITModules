...
/**
 * <p>Java class for LteSonTpmGetResult complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LteSonTpmGetResult"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="TpmStatus" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
...
@XmlType(name = "LteSonTpmGetResult", propOrder = {
    "nodeResult",
    "name",
    "nodeId",
    "tpmStatus",
...
public class LteSonTpmGetResult
    extends WsResponse
{
    ...
    @XmlElementRef(name = "TpmStatus", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> tpmStatus;
    ...
    /**
     * Gets the value of the tpmStatus property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<Boolean> getTpmStatus() {
        return tpmStatus;
    }

    /**
     * Sets the value of the tpmStatus property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Boolean }{@code >}
     *     
     */
    public void setTpmStatus(JAXBElement<Boolean> value) {
