 ...
 *         &lt;element name="Qci1Bearer" type="{http://Airspan.Netspan.WebServices}Qci1BearerStateWs" minOccurs="0"/&gt;
...
public class RelayStatusWs {
    ...
    @XmlElementRef(name = "Qci1Bearer", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<Qci1BearerStateWs> qci1Bearer;
    ...
    /**
     * Gets the value of the qci1Bearer property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Qci1BearerStateWs }{@code >}
     *     
     */
    public JAXBElement<Qci1BearerStateWs> getQci1Bearer() {
        return qci1Bearer;
    }

    /**
     * Sets the value of the qci1Bearer property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Qci1BearerStateWs }{@code >}
     *     
     */
    public void setQci1Bearer(JAXBElement<Qci1BearerStateWs> value) {
        this.qci1Bearer = value;
    }
