 ...
 *         &lt;element name="CaAvgThroughputKbpsDl" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/&gt;
 *         &lt;element name="CaAvgThroughputKbpsUl" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/&gt;
 *         &lt;element name="RlcTrafficKbpsDl" type="{http://www.w3.org/2001/XMLSchema}double" minOccurs="0"/&gt;
 *         &lt;element name="RlcTrafficKbpsUl" type="{http://www.w3.org/2001/XMLSchema}double" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "LteIpThroughputQciWs", propOrder = {
    ...
    "macTrafficKbpsDl",
    "macTrafficKbpsUl",
    "caAvgThroughputKbpsDl",
    "caAvgThroughputKbpsUl",
    "rlcTrafficKbpsDl",
    "rlcTrafficKbpsUl"
})
public class LteIpThroughputQciWs {
    ...
    @XmlElementRef(name = "CaAvgThroughputKbpsDl", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> caAvgThroughputKbpsDl;
    @XmlElementRef(name = "CaAvgThroughputKbpsUl", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> caAvgThroughputKbpsUl;
    @XmlElementRef(name = "RlcTrafficKbpsDl", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<Double> rlcTrafficKbpsDl;
    @XmlElementRef(name = "RlcTrafficKbpsUl", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<Double> rlcTrafficKbpsUl;
    ...
    /**
     * Gets the value of the caAvgThroughputKbpsDl property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Integer }{@code >}
     *     
     */
    public JAXBElement<Integer> getCaAvgThroughputKbpsDl() {
        return caAvgThroughputKbpsDl;
    }

    /**
     * Sets the value of the caAvgThroughputKbpsDl property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Integer }{@code >}
     *     
     */
    public void setCaAvgThroughputKbpsDl(JAXBElement<Integer> value) {
        this.caAvgThroughputKbpsDl = value;
    }

    /**
     * Gets the value of the caAvgThroughputKbpsUl property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Integer }{@code >}
     *     
     */
    public JAXBElement<Integer> getCaAvgThroughputKbpsUl() {
        return caAvgThroughputKbpsUl;
    }

    /**
     * Sets the value of the caAvgThroughputKbpsUl property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Integer }{@code >}
     *     
     */
    public void setCaAvgThroughputKbpsUl(JAXBElement<Integer> value) {
        this.caAvgThroughputKbpsUl = value;
    }

    /**
     * Gets the value of the rlcTrafficKbpsDl property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<Double> getRlcTrafficKbpsDl() {
        return rlcTrafficKbpsDl;
    }

    /**
     * Sets the value of the rlcTrafficKbpsDl property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Double }{@code >}
     *     
     */
    public void setRlcTrafficKbpsDl(JAXBElement<Double> value) {
        this.rlcTrafficKbpsDl = value;
    }

    /**
     * Gets the value of the rlcTrafficKbpsUl property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Double }{@code >}
     *     
     */
    public JAXBElement<Double> getRlcTrafficKbpsUl() {
        return rlcTrafficKbpsUl;
    }

    /**
     * Sets the value of the rlcTrafficKbpsUl property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Double }{@code >}
     *     
     */
    public void setRlcTrafficKbpsUl(JAXBElement<Double> value) {
        this.rlcTrafficKbpsUl = value;
    }
