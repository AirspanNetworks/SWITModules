...
public class RelayConnectedDevicesWs {
    ...
    @XmlElementRef(name = "Connected", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> connected;
    @XmlElement(name = "Details")
    protected String details;
    @XmlElementRef(name = "VlanId", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> vlanId;
     ...
     *     
     */
    public JAXBElement<Integer> getVlanId() {
        return vlanId;
    }
     ...
     *     
     */
    public void setVlanId(JAXBElement<Integer> value) {
        this.vlanId = value;
    }
