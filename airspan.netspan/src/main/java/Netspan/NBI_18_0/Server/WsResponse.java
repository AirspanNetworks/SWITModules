...
@XmlSeeAlso({
    ItemActionResult.class,
    NmsLicenseListResult.class,
    NmsLicenseSummaryListResult.class,
    LicenseNodeSummaryListResult.class,
    NameResult.class,
    UserResponse.class,
    NmsUserGetResult.class,
    NmsInfoResponse.class,
    ClientRequestInfoResponse.class,
    CtsResponse.class,
    CtsGetResult.class,
    NodeFileUploadGetWs.class,
    NmsServerIPAddressListWs.class,
    NmsServerIPAddressGetWs.class,
    FileServerResponse.class,
    SasServerResponse.class,
    TrapResyncResponse2 .class,
    CbrsStatusResponse.class
})
