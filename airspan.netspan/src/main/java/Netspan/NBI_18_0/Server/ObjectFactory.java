 ...
 * generated in the Netspan.NBI_18_0.Server package. 
...
public class ObjectFactory {
    ...
    private final static QName _NmsUserGetWsIsSuspended_QNAME = new QName("http://Airspan.Netspan.WebServices", "IsSuspended");
    private final static QName _NmsUserGetWsExpiryDate_QNAME = new QName("http://Airspan.Netspan.WebServices", "ExpiryDate");
    private final static QName _CbrsStatusResponseNetspanLastUpdated_QNAME = new QName("http://Airspan.Netspan.WebServices", "NetspanLastUpdated");
    private final static QName _CbrsStatusResponseBackupProxyLastSyncSeconds_QNAME = new QName("http://Airspan.Netspan.WebServices", "BackupProxyLastSyncSeconds");
    private final static QName _CbrsStatusResponseBackupProxyLastHeartbeatSeconds_QNAME = new QName("http://Airspan.Netspan.WebServices", "BackupProxyLastHeartbeatSeconds");
    private final static QName _CbrsStatusResponseBackupProxyLastUpdated_QNAME = new QName("http://Airspan.Netspan.WebServices", "BackupProxyLastUpdated");
    private final static QName _CbrsStatusResponseCbsdTotal_QNAME = new QName("http://Airspan.Netspan.WebServices", "CbsdTotal");
    private final static QName _CbrsStatusResponseCbsdUnregistered_QNAME = new QName("http://Airspan.Netspan.WebServices", "CbsdUnregistered");
    private final static QName _CbrsStatusResponseCbsdRegistered_QNAME = new QName("http://Airspan.Netspan.WebServices", "CbsdRegistered");
    private final static QName _CbrsStatusResponseCbsdSiSuccess_QNAME = new QName("http://Airspan.Netspan.WebServices", "CbsdSiSuccess");
    private final static QName _CbrsStatusResponseCbsdGranted_QNAME = new QName("http://Airspan.Netspan.WebServices", "CbsdGranted");
    private final static QName _CbrsStatusResponseCbsdAuthorized_QNAME = new QName("http://Airspan.Netspan.WebServices", "CbsdAuthorized");
    private final static QName _CbrsStatusResponseCbsdDeregistered_QNAME = new QName("http://Airspan.Netspan.WebServices", "CbsdDeregistered");
    ...
    private final static QName _NmsInfoResponseLastUpgradeTime_QNAME = new QName("http://Airspan.Netspan.WebServices", "LastUpgradeTime");
    ...
    private final static QName _NmsUserSetWsIsRestrictToNodeGroups_QNAME = new QName("http://Airspan.Netspan.WebServices", "IsRestrictToNodeGroups");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: Netspan.NBI_18_0.Server
     * 
     */
    ...
    /**
     * Create an instance of {@link TrapResync }
     * 
     */
    public TrapResync createTrapResync() {
        return new TrapResync();
    }

    /**
     * Create an instance of {@link TrapResyncSet }
     * 
     */
    public TrapResyncSet createTrapResyncSet() {
        return new TrapResyncSet();
    }

    /**
     * Create an instance of {@link TrapResyncResponse }
     * 
     */
    public TrapResyncResponse createTrapResyncResponse() {
        return new TrapResyncResponse();
    }

    /**
     * Create an instance of {@link TrapResyncResponse2 }
     * 
     */
    public TrapResyncResponse2 createTrapResyncResponse2() {
        return new TrapResyncResponse2();
    }

    /**
     * Create an instance of {@link CbrsStatusGet }
     * 
     */
    public CbrsStatusGet createCbrsStatusGet() {
        return new CbrsStatusGet();
    }

    /**
     * Create an instance of {@link CbrsStatusGetResponse }
     * 
     */
    public CbrsStatusGetResponse createCbrsStatusGetResponse() {
        return new CbrsStatusGetResponse();
    }

    /**
     * Create an instance of {@link CbrsStatusResponse }
     * 
     */
    public CbrsStatusResponse createCbrsStatusResponse() {
        return new CbrsStatusResponse();
    }
    ...
    /**
     * Create an instance of {@link NodeGroupsWs }
     * 
     */
    public NodeGroupsWs createNodeGroupsWs() {
        return new NodeGroupsWs();
    }
    ...
    /**
     * Create an instance of {@link TrapResyncResultListContainer }
     * 
     */
    public TrapResyncResultListContainer createTrapResyncResultListContainer() {
        return new TrapResyncResultListContainer();
    }

    /**
     * Create an instance of {@link TrapResyncResult }
     * 
     */
    public TrapResyncResult createTrapResyncResult() {
        return new TrapResyncResult();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Airspan.Netspan.WebServices", name = "IsSuspended", scope = NmsUserGetWs.class)
    public JAXBElement<Boolean> createNmsUserGetWsIsSuspended(Boolean value) {
        return new JAXBElement<Boolean>(_NmsUserGetWsIsSuspended_QNAME, Boolean.class, NmsUserGetWs.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Airspan.Netspan.WebServices", name = "ExpiryDate", scope = NmsUserGetWs.class)
    public JAXBElement<XMLGregorianCalendar> createNmsUserGetWsExpiryDate(XMLGregorianCalendar value) {
        return new JAXBElement<XMLGregorianCalendar>(_NmsUserGetWsExpiryDate_QNAME, XMLGregorianCalendar.class, NmsUserGetWs.class, value);
    }
    ...
    public JAXBElement<XMLGregorianCalendar> createNmsLicensedNodesWsExpiryDate(XMLGregorianCalendar value) {
        return new JAXBElement<XMLGregorianCalendar>(_NmsUserGetWsExpiryDate_QNAME, XMLGregorianCalendar.class, NmsLicensedNodesWs.class, value);
    }
    ...
    public JAXBElement<XMLGregorianCalendar> createNmsLicenseSummaryWsExpiryDate(XMLGregorianCalendar value) {
        return new JAXBElement<XMLGregorianCalendar>(_NmsUserGetWsExpiryDate_QNAME, XMLGregorianCalendar.class, NmsLicenseSummaryWs.class, value);
    }
    ...
    public JAXBElement<XMLGregorianCalendar> createNmsLicenseWsExpiryDate(XMLGregorianCalendar value) {
        return new JAXBElement<XMLGregorianCalendar>(_NmsUserGetWsExpiryDate_QNAME, XMLGregorianCalendar.class, NmsLicenseWs.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Airspan.Netspan.WebServices", name = "NetspanLastUpdated", scope = CbrsStatusResponse.class)
    public JAXBElement<XMLGregorianCalendar> createCbrsStatusResponseNetspanLastUpdated(XMLGregorianCalendar value) {
        return new JAXBElement<XMLGregorianCalendar>(_CbrsStatusResponseNetspanLastUpdated_QNAME, XMLGregorianCalendar.class, CbrsStatusResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Airspan.Netspan.WebServices", name = "BackupProxyLastSyncSeconds", scope = CbrsStatusResponse.class)
    public JAXBElement<Integer> createCbrsStatusResponseBackupProxyLastSyncSeconds(Integer value) {
        return new JAXBElement<Integer>(_CbrsStatusResponseBackupProxyLastSyncSeconds_QNAME, Integer.class, CbrsStatusResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Airspan.Netspan.WebServices", name = "BackupProxyLastHeartbeatSeconds", scope = CbrsStatusResponse.class)
    public JAXBElement<Integer> createCbrsStatusResponseBackupProxyLastHeartbeatSeconds(Integer value) {
        return new JAXBElement<Integer>(_CbrsStatusResponseBackupProxyLastHeartbeatSeconds_QNAME, Integer.class, CbrsStatusResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Airspan.Netspan.WebServices", name = "BackupProxyLastUpdated", scope = CbrsStatusResponse.class)
    public JAXBElement<XMLGregorianCalendar> createCbrsStatusResponseBackupProxyLastUpdated(XMLGregorianCalendar value) {
        return new JAXBElement<XMLGregorianCalendar>(_CbrsStatusResponseBackupProxyLastUpdated_QNAME, XMLGregorianCalendar.class, CbrsStatusResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Airspan.Netspan.WebServices", name = "CbsdTotal", scope = CbrsStatusResponse.class)
    public JAXBElement<Integer> createCbrsStatusResponseCbsdTotal(Integer value) {
        return new JAXBElement<Integer>(_CbrsStatusResponseCbsdTotal_QNAME, Integer.class, CbrsStatusResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Airspan.Netspan.WebServices", name = "CbsdUnregistered", scope = CbrsStatusResponse.class)
    public JAXBElement<Integer> createCbrsStatusResponseCbsdUnregistered(Integer value) {
        return new JAXBElement<Integer>(_CbrsStatusResponseCbsdUnregistered_QNAME, Integer.class, CbrsStatusResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Airspan.Netspan.WebServices", name = "CbsdRegistered", scope = CbrsStatusResponse.class)
    public JAXBElement<Integer> createCbrsStatusResponseCbsdRegistered(Integer value) {
        return new JAXBElement<Integer>(_CbrsStatusResponseCbsdRegistered_QNAME, Integer.class, CbrsStatusResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Airspan.Netspan.WebServices", name = "CbsdSiSuccess", scope = CbrsStatusResponse.class)
    public JAXBElement<Integer> createCbrsStatusResponseCbsdSiSuccess(Integer value) {
        return new JAXBElement<Integer>(_CbrsStatusResponseCbsdSiSuccess_QNAME, Integer.class, CbrsStatusResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Airspan.Netspan.WebServices", name = "CbsdGranted", scope = CbrsStatusResponse.class)
    public JAXBElement<Integer> createCbrsStatusResponseCbsdGranted(Integer value) {
        return new JAXBElement<Integer>(_CbrsStatusResponseCbsdGranted_QNAME, Integer.class, CbrsStatusResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Airspan.Netspan.WebServices", name = "CbsdAuthorized", scope = CbrsStatusResponse.class)
    public JAXBElement<Integer> createCbrsStatusResponseCbsdAuthorized(Integer value) {
        return new JAXBElement<Integer>(_CbrsStatusResponseCbsdAuthorized_QNAME, Integer.class, CbrsStatusResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Airspan.Netspan.WebServices", name = "CbsdDeregistered", scope = CbrsStatusResponse.class)
    public JAXBElement<Integer> createCbrsStatusResponseCbsdDeregistered(Integer value) {
        return new JAXBElement<Integer>(_CbrsStatusResponseCbsdDeregistered_QNAME, Integer.class, CbrsStatusResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Airspan.Netspan.WebServices", name = "LastUpgradeTime", scope = NmsInfoResponse.class)
    public JAXBElement<XMLGregorianCalendar> createNmsInfoResponseLastUpgradeTime(XMLGregorianCalendar value) {
        return new JAXBElement<XMLGregorianCalendar>(_NmsInfoResponseLastUpgradeTime_QNAME, XMLGregorianCalendar.class, NmsInfoResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Airspan.Netspan.WebServices", name = "IsRestrictToNodeGroups", scope = NmsUserSetWs.class)
    public JAXBElement<Boolean> createNmsUserSetWsIsRestrictToNodeGroups(Boolean value) {
        return new JAXBElement<Boolean>(_NmsUserSetWsIsRestrictToNodeGroups_QNAME, Boolean.class, NmsUserSetWs.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Airspan.Netspan.WebServices", name = "IsSuspended", scope = NmsUserSetWs.class)
    public JAXBElement<Boolean> createNmsUserSetWsIsSuspended(Boolean value) {
        return new JAXBElement<Boolean>(_NmsUserGetWsIsSuspended_QNAME, Boolean.class, NmsUserSetWs.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Airspan.Netspan.WebServices", name = "ExpiryDate", scope = NmsUserSetWs.class)
    public JAXBElement<XMLGregorianCalendar> createNmsUserSetWsExpiryDate(XMLGregorianCalendar value) {
        return new JAXBElement<XMLGregorianCalendar>(_NmsUserGetWsExpiryDate_QNAME, XMLGregorianCalendar.class, NmsUserSetWs.class, value);
    }
