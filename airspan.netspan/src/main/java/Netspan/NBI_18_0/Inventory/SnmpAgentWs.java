 ...
 *         &lt;element name="ActualOperationalStatus" type="{http://Airspan.Netspan.WebServices}OperationalStatusExtendedValues" minOccurs="0"/&gt;
 *         &lt;element name="RequestedOperationalStatus" type="{http://Airspan.Netspan.WebServices}OperationalStatusExtendedValues" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class SnmpAgentWs {
    ...
    protected JAXBElement<OperationalStatusExtendedValues> actualOperationalStatus;
    ...
    protected JAXBElement<OperationalStatusExtendedValues> requestedOperationalStatus;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link OperationalStatusExtendedValues }{@code >}
     *     
     */
    public JAXBElement<OperationalStatusExtendedValues> getActualOperationalStatus() {
     ...
     *     
     */
    public void setActualOperationalStatus(JAXBElement<OperationalStatusExtendedValues> value) {
     ...
     *     
     */
    public JAXBElement<OperationalStatusExtendedValues> getRequestedOperationalStatus() {
     ...
     *     
     */
    public void setRequestedOperationalStatus(JAXBElement<OperationalStatusExtendedValues> value) {
