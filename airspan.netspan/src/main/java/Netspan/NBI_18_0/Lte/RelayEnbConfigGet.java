 ...
 *         &lt;element name="HardwareType" type="{http://Airspan.Netspan.WebServices}RelayEnbModelIds" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "RelayEnbConfigGet")
public class RelayEnbConfigGet {

    @XmlElement(name = "NodeName")
    protected List<String> nodeName;
    @XmlElement(name = "HardwareType")
    @XmlSchemaType(name = "string")
    protected List<RelayEnbModelIds> hardwareType;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RelayEnbModelIds }
     * 
     * 
     */
    public List<RelayEnbModelIds> getHardwareType() {
        if (hardwareType == null) {
            hardwareType = new ArrayList<RelayEnbModelIds>();
        }
