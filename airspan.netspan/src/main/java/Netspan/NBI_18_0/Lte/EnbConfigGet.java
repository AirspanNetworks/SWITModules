 ...
 *         &lt;element name="HardwareType" type="{http://Airspan.Netspan.WebServices}EnbModelIds" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "EnbConfigGet")
public class EnbConfigGet {

    @XmlElement(name = "NodeName")
    protected List<String> nodeName;
    @XmlElement(name = "HardwareType")
    @XmlSchemaType(name = "string")
    protected List<EnbModelIds> hardwareType;
     ...
     * 
     */
    public List<EnbModelIds> getHardwareType() {
        if (hardwareType == null) {
            hardwareType = new ArrayList<EnbModelIds>();
        }
