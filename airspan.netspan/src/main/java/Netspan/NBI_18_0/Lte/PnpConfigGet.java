 ...
 *         &lt;element name="HardwareType" type="{http://Airspan.Netspan.WebServices}PnpHardwareTypes" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "PnpConfigGet")
public class PnpConfigGet {

    @XmlElement(name = "NodeName")
    protected List<String> nodeName;
    @XmlElement(name = "HardwareType")
    @XmlSchemaType(name = "string")
    protected List<PnpHardwareTypes> hardwareType;
     ...
     * 
     */
    public List<PnpHardwareTypes> getHardwareType() {
        if (hardwareType == null) {
            hardwareType = new ArrayList<PnpHardwareTypes>();
        }
