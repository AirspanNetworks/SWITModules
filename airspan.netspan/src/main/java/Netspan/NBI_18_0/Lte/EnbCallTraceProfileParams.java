...
public class EnbCallTraceProfileParams {
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link TransportModesWs }{@code >}
     *     
     */
    public JAXBElement<TransportModesWs> getTransportLayer() {
     ...
     *     
     */
    public void setTransportLayer(JAXBElement<TransportModesWs> value) {
        this.transportLayer = value;
    }

    /**
     * Gets the value of the vendorSpecificEvents property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link EnabledDisabledStates }{@code >}
    ...
    /**
     * Sets the value of the vendorSpecificEvents property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link EnabledDisabledStates }{@code >}
