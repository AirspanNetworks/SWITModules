 ...
 * 
 * <pre>
 * &lt;complexType name="EnbSyncProfile"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://Airspan.Netspan.WebServices}EnbSyncProfileParams"&gt;
 *       &lt;sequence&gt;
...
@XmlType(name = "EnbSyncProfile", propOrder = {
    "name",
    "hardwareCategory"
})
@XmlSeeAlso({
    EnbSyncProfileGet.class
})
public class EnbSyncProfile
    extends EnbSyncProfileParams
{
