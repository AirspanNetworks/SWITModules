 ...
 *         &lt;element name="UlActiveTti" type="{http://www.w3.org/2001/XMLSchema}long" minOccurs="0"/&gt;
 ...
 *         &lt;element name="CaThpUl" type="{http://www.w3.org/2001/XMLSchema}double" minOccurs="0"/&gt;
 *         &lt;element name="CaThpDl" type="{http://www.w3.org/2001/XMLSchema}double" minOccurs="0"/&gt;
 *         &lt;element name="DlPeakPrbUsageForTraffic" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/&gt;
 *         &lt;element name="UlPeakPrbUsageForTraffic" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "LteRruPerQciStatsRowWs", propOrder = {
    ...
    "caThpUl",
    "caThpDl",
    "dlPeakPrbUsageForTraffic",
    "ulPeakPrbUsageForTraffic"
})
public class LteRruPerQciStatsRowWs {
    ...
    protected JAXBElement<Long> ulActiveTti;
    ...
    @XmlElementRef(name = "CaThpUl", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<Double> caThpUl;
    @XmlElementRef(name = "CaThpDl", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<Double> caThpDl;
    @XmlElementRef(name = "DlPeakPrbUsageForTraffic", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> dlPeakPrbUsageForTraffic;
    @XmlElementRef(name = "UlPeakPrbUsageForTraffic", namespace = "http://Airspan.Netspan.WebServices", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> ulPeakPrbUsageForTraffic;
     ...
     *     
     */
    public JAXBElement<Long> getUlActiveTti() {
        return ulActiveTti;
    }
     ...
     *     
     */
    public void setUlActiveTti(JAXBElement<Long> value) {
    ...
    /**
     * Gets the value of the caThpUl property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Double }{@code >}
     *     
     */
    public JAXBElement<Double> getCaThpUl() {
        return caThpUl;
    }

    /**
     * Sets the value of the caThpUl property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Double }{@code >}
     *     
     */
    public void setCaThpUl(JAXBElement<Double> value) {
        this.caThpUl = value;
    }

    /**
     * Gets the value of the caThpDl property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Double }{@code >}
     *     
     */
    public JAXBElement<Double> getCaThpDl() {
        return caThpDl;
    }

    /**
     * Sets the value of the caThpDl property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Double }{@code >}
     *     
     */
    public void setCaThpDl(JAXBElement<Double> value) {
        this.caThpDl = value;
    }

    /**
     * Gets the value of the dlPeakPrbUsageForTraffic property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Integer }{@code >}
     *     
     */
    public JAXBElement<Integer> getDlPeakPrbUsageForTraffic() {
        return dlPeakPrbUsageForTraffic;
    }

    /**
     * Sets the value of the dlPeakPrbUsageForTraffic property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Integer }{@code >}
     *     
     */
    public void setDlPeakPrbUsageForTraffic(JAXBElement<Integer> value) {
        this.dlPeakPrbUsageForTraffic = value;
    }

    /**
     * Gets the value of the ulPeakPrbUsageForTraffic property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Integer }{@code >}
     *     
     */
    public JAXBElement<Integer> getUlPeakPrbUsageForTraffic() {
        return ulPeakPrbUsageForTraffic;
    }

    /**
     * Sets the value of the ulPeakPrbUsageForTraffic property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Integer }{@code >}
     *     
     */
    public void setUlPeakPrbUsageForTraffic(JAXBElement<Integer> value) {
        this.ulPeakPrbUsageForTraffic = value;
    }
