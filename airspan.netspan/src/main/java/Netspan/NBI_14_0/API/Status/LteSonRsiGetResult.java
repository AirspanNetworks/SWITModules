...
/**
 * <p>Java class for LteSonRsiGetResult complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LteSonRsiGetResult">
 *   &lt;complexContent>
 ...
 *         &lt;element name="Cell" type="{http://Airspan.Netspan.WebServices}LteRsiStatusWs" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "LteSonRsiGetResult", propOrder = {
    "nodeResult",
    "name",
    "nodeId",
    "cell"
})
public class LteSonRsiGetResult
    extends WsResponse
{
    ...
    protected List<LteRsiStatusWs> cell;
     ...
     * 
     */
    public List<LteRsiStatusWs> getCell() {
        if (cell == null) {
            cell = new ArrayList<LteRsiStatusWs>();
        }
        return this.cell;
    }
