 ...
 *         &lt;element name="IsAnrEnabled" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
    ...
    extends WsResponse
{
    ...
    @XmlElement(name = "IsAnrEnabled", required = true, type = Boolean.class, nillable = true)
    protected Boolean isAnrEnabled;
    @XmlElement(name = "Anr")
     ...
     *     
     */
    public void setIsAnrEnabled(Boolean value) {
