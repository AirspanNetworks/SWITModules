 ...
 *         &lt;element name="LastReadFromNode" type="{http://www.w3.org/2001/XMLSchema}dateTime"/>
...
public class SwStatusWs {
    ...
    @XmlElement(name = "LastReadFromNode", required = true, nillable = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar lastReadFromNode;
     ...
     *     
     */
    public XMLGregorianCalendar getLastReadFromNode() {
     ...
     *     
     */
    public void setLastReadFromNode(XMLGregorianCalendar value) {
