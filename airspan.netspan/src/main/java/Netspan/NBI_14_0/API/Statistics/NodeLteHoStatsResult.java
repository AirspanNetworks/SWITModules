...
/**
 * <p>Java class for NodeLteHoStatsResult complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="NodeLteHoStatsResult">
 *   &lt;complexContent>
 ...
 *         &lt;element name="LteHoStatsRow" type="{http://Airspan.Netspan.WebServices}LteHoStatsRowWs" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "NodeLteHoStatsResult", propOrder = {
    "name",
    "nodeId",
    "nodeResult",
    "lteHoStatsRow"
})
public class NodeLteHoStatsResult {
    ...
    protected List<LteHoStatsRowWs> lteHoStatsRow;
     ...
     * {@link LteHoStatsRowWs }
     * 
     * 
     */
    public List<LteHoStatsRowWs> getLteHoStatsRow() {
        if (lteHoStatsRow == null) {
            lteHoStatsRow = new ArrayList<LteHoStatsRowWs>();
        }
