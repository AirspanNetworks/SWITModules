 ...
 *         &lt;element name="NetworkProfileResult" type="{http://Airspan.Netspan.WebServices}LteNetworkProfileWs" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends WsResponse
{
    ...
    protected List<LteNetworkProfileWs> networkProfileResult;
     ...
     * 
     */
    public List<LteNetworkProfileWs> getNetworkProfileResult() {
        if (networkProfileResult == null) {
            networkProfileResult = new ArrayList<LteNetworkProfileWs>();
        }
