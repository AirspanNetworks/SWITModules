 ...
 *         &lt;element name="SonProfileResult" type="{http://Airspan.Netspan.WebServices}LteSonProfileWs" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends WsResponse
{
    ...
    protected List<LteSonProfileWs> sonProfileResult;
     ...
     * 
     */
    public List<LteSonProfileWs> getSonProfileResult() {
        if (sonProfileResult == null) {
            sonProfileResult = new ArrayList<LteSonProfileWs>();
        }
