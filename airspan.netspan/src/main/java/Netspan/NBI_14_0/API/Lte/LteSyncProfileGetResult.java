 ...
 *         &lt;element name="SyncProfileResult" type="{http://Airspan.Netspan.WebServices}LteSyncProfileWs" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends WsResponse
{
    ...
    protected List<LteSyncProfileWs> syncProfileResult;
     ...
     * 
     */
    public List<LteSyncProfileWs> getSyncProfileResult() {
        if (syncProfileResult == null) {
            syncProfileResult = new ArrayList<LteSyncProfileWs>();
        }
