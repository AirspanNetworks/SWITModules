 ...
 *       &lt;sequence>
 *         &lt;element name="Neighbour" type="{http://Airspan.Netspan.WebServices}LteNeighbourWs" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends WsResponse
{
    ...
    protected List<LteNeighbourWs> neighbour;
     ...
     * 
     */
    public List<LteNeighbourWs> getNeighbour() {
        if (neighbour == null) {
            neighbour = new ArrayList<LteNeighbourWs>();
        }
