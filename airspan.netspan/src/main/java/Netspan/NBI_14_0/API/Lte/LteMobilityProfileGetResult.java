 ...
 *         &lt;element name="MobilityProfileResult" type="{http://Airspan.Netspan.WebServices}LteMobilityProfileWs" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends WsResponse
{
    ...
    protected List<LteMobilityProfileWs> mobilityProfileResult;
     ...
     * {@link LteMobilityProfileWs }
     * 
     * 
     */
    public List<LteMobilityProfileWs> getMobilityProfileResult() {
        if (mobilityProfileResult == null) {
            mobilityProfileResult = new ArrayList<LteMobilityProfileWs>();
        }
