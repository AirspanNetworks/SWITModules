 ...
 *       &lt;sequence>
 *         &lt;element name="PnpConfig" type="{http://Airspan.Netspan.WebServices}PnpConfigWs" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends WsResponse
{
    ...
    protected List<PnpConfigWs> pnpConfig;
     ...
     * 
     */
    public List<PnpConfigWs> getPnpConfig() {
        if (pnpConfig == null) {
            pnpConfig = new ArrayList<PnpConfigWs>();
        }
