 ...
 *         &lt;element name="ManagementProfileResult" type="{http://Airspan.Netspan.WebServices}LteManagementProfileWs" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends WsResponse
{
    ...
    protected List<LteManagementProfileWs> managementProfileResult;
     ...
     * 
     */
    public List<LteManagementProfileWs> getManagementProfileResult() {
        if (managementProfileResult == null) {
            managementProfileResult = new ArrayList<LteManagementProfileWs>();
        }
